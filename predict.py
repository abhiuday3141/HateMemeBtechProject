...
def predict(image_model, text_model, fusion_model, test_dataloader, device):
    ...
    with open('output.csv',mode='w') as output_file:
        ...
        for batch_num, (feats, captions, input_ids, attention_masks, input_ids_cap, attention_masks_cap, target) in                     enumerate(test_dataloader):
            ...
            for index,name in enumerate(list(target)):
